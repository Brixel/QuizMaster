        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnswerMustContain = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Question_Round_RoundId",
                        column: x => x.RoundId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    QuizMasterId = table.Column<int>(nullable: true),
                    QuizId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Games_User_QuizMasterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Games_QuizMasterId",
                table: "Games",
                column: "QuizMasterId");

            migrationBuilder.CreateIndex(
                name: "IX_Question_RoundId",
                table: "Question",
                column: "RoundId");
